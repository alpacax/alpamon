...
// NewTunnelClientWithURL creates a new tunnel client for the given WebSocket URL.
func NewTunnelClientWithURL(sessionID, channelID, protocol string, targetPort int, wsURL string) *TunnelClient {
	headers := http.Header{
