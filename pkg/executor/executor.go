...
// Flush sends any remaining buffered content as a final chunk.
...
// Bytes returns the complete combined output accumulated so far.
...
// When chunkCallback is non-nil, output is streamed to the callback via
